...
const (
	...
	TokenOwner_OGI_IDENTIFIER TokenOwner_Type = 10
)
...
type TokenAction_Stransfer struct {
	Stransfer *SignedTransfer `protobuf:"bytes,4,opt,name=stransfer,proto3,oneof"`
}

type TokenAction_Sredeem struct {
	Sredeem *SignedTransfer `protobuf:"bytes,5,opt,name=sredeem,proto3,oneof"`
}
...
func (*TokenAction_Stransfer) isTokenAction_Data() {}

func (*TokenAction_Sredeem) isTokenAction_Data() {}
...
func (m *TokenAction) GetStransfer() *SignedTransfer {
	if x, ok := m.GetData().(*TokenAction_Stransfer); ok {
		return x.Stransfer
	}
	return nil
}

func (m *TokenAction) GetSredeem() *SignedTransfer {
	if x, ok := m.GetData().(*TokenAction_Sredeem); ok {
		return x.Sredeem
	}
	return nil
}
...
func (*TokenAction) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*TokenAction_Stransfer)(nil),
		(*TokenAction_Sredeem)(nil),
	}
}
...
type TransferSignature struct {
	...
	HashGroups           [][]byte `protobuf:"bytes,4,rep,name=hashGroups,proto3" json:"hashGroups,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *TransferSignature) Reset()         { *m = TransferSignature{} }
func (m *TransferSignature) String() string { return proto.CompactTextString(m) }
func (*TransferSignature) ProtoMessage()    {}
func (*TransferSignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cc4e03d2c28c490, []int{4}
}

func (m *TransferSignature) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TransferSignature.Unmarshal(m, b)
}
func (m *TransferSignature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TransferSignature.Marshal(b, m, deterministic)
}
func (m *TransferSignature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TransferSignature.Merge(m, src)
}
func (m *TransferSignature) XXX_Size() int {
	return xxx_messageInfo_TransferSignature.Size(m)
}
func (m *TransferSignature) XXX_DiscardUnknown() {
	xxx_messageInfo_TransferSignature.DiscardUnknown(m)
}

var xxx_messageInfo_TransferSignature proto.InternalMessageInfo

func (m *TransferSignature) GetCredential() []byte {
	if m != nil {
		return m.Credential
	}
	return nil
...
func (m *TransferSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *TransferSignature) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *TransferSignature) GetHashGroups() [][]byte {
	if m != nil {
		return m.HashGroups
	}
	return nil
...
type SignedTransfer struct {
	...
	// Transfer Signature based on OGI
	TransferSignature    []byte   `protobuf:"bytes,2,opt,name=transfer_signature,json=transferSignature,proto3" json:"transfer_signature,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *SignedTransfer) Reset()         { *m = SignedTransfer{} }
func (m *SignedTransfer) String() string { return proto.CompactTextString(m) }
func (*SignedTransfer) ProtoMessage()    {}
func (*SignedTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cc4e03d2c28c490, []int{5}
}

func (m *SignedTransfer) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SignedTransfer.Unmarshal(m, b)
}
func (m *SignedTransfer) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SignedTransfer.Marshal(b, m, deterministic)
}
func (m *SignedTransfer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SignedTransfer.Merge(m, src)
}
func (m *SignedTransfer) XXX_Size() int {
	return xxx_messageInfo_SignedTransfer.Size(m)
}
func (m *SignedTransfer) XXX_DiscardUnknown() {
	xxx_messageInfo_SignedTransfer.DiscardUnknown(m)
}

var xxx_messageInfo_SignedTransfer proto.InternalMessageInfo

func (m *SignedTransfer) GetTransfer() []byte {
	if m != nil {
		return m.Transfer
	}
	return nil
...
func (m *SignedTransfer) GetTransferSignature() []byte {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*TransferSignature)(nil), "token.TransferSignature")
	proto.RegisterType((*SignedTransfer)(nil), "token.SignedTransfer")
...
var fileDescriptor_2cc4e03d2c28c490 = []byte{
	...
	,
}
